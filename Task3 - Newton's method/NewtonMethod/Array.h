...
public:
	...
	friend double* stMethNewt(double*X, const int n, Array F, Array J, double eps, double &diff);
	friend double* modifiedMethNewt(double*X, const int n, Array F, Array J, double eps, double &diff);
